...
public class EstudianteServicio implements IEstudianteServicio {
    ...
    @Override
    public Estudiantes2025 buscarEstudiantePorId(Integer idEstudiante2025) {
        Estudiantes2025 estudiante = estudianteRepositorio.findById(idEstudiante2025).orElse(null);
        return estudiante;
    }
