...
public class SistemaEstudiantesApp {
    public static void main(String[] args) {
        ...
        var estudianteDao = new EstudianteDAO(); //Esto se hace una vez
        while (!salir) {
            try {
                mostrarMenu(); //Este sera el metodo que devolera booleano
    ...
    //puede moficiar el valor de la variable salir, si es verdadero termina el ciclo while
    private static boolean ejecutarOpciones(Scanner consola, EstudianteDAO estudianteDAO) {
        ...
        switch (opcion) {
            case 1 -> { //Listar estudiantes
                ...
                // no muestra la inforamcion, solo recupera la info y regresa una lista
            ...
            case 4 -> { //Modificar estudiante
                ...
                //Aca lo primero es especifcar cual es el id del objeto a modificar
